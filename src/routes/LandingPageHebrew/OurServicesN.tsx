            ...
            <div className="cards">
                <div className="cards-container-heb">
                    <ServiceCard
                        ...
                        description="תקבלו חנות אונליין שמוכרת באמת, המשלבת הבנה שיווקית עמוקה עם פיתוח מתקדם. החנות שלכם תמשוך את הלקוחות הנכונים ותעודד אותם לבצע רכישה. נבנה עבורכם אסטרטגיה להגדלת המכירות, באמצעות עיצוב מושך, חוויית משתמש חלקה והנעה לפעולה ברורה."
                        />
                    <ServiceCard
