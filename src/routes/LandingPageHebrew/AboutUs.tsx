        ...
        <section className="aboutUs-container">
            <div className="aboutUs-content">
                ...
                <p className="aboutUs-description">
                    ...
                    <span>
                        אנחנו צוות Orime –
                        <strong> צופיה, תמר ואלכס – חברים שחיים ונושמים טכנולוגיה ועיצוב. </strong> כל אחד מאיתנו מביא את הייחודיות שלו: צופיה ותמר מפתחות Full Stack עם תשוקה לקוד ולפתרון בעיות, ואלכס מעצב UX/UI שמאמין בכוחו של עיצוב טוב ליצור חוויית משתמש בלתי נשכחת.
                    </span>
                    <br />
                </p>
                <p className="aboutUs-description">
