            ...
            <div className="step-container">
                <div className="step-right-side">
                    ...
                    <div className="step-card right num4 stategy">
                        ...
                        <h3>השקה ותמיכה:</h3>
                        <p>
                        נלווה אותך בתהליך ההשקה, ונדאג שהכל פועל חלק. גם לאחר ההשקה, אנחנו כאן בשבילך לכל שאלה או צורך.
                        </p>
                    </div>
                </div>
                ...
                <div className="step-left-side">
                    ...
                    <div className="step-card left num3 experience">
                        ...
                        <h3>עיצוב ופיתוח:</h3>
                        <p>
                        נעבוד בצמוד כדי ליצור מוצר שמשלב יופי וטכנולוגיה. אנחנו נשלב את היכולות שלנו בעיצוב ופיתוח כדי להביא את הרעיון שלך לחיים, עם קוד נקי ועיצוב מרהיב.
